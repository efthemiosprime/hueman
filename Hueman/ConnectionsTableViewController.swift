...
class ConnectionsTableViewController: UITableViewController {
    ...
    override func viewDidLoad() {
      ...
      //  self.tableView.frame = CGRectMake(0, 75, self.tableView.frame.size.width, self.tableView.frame.size.height)
        ...
        searchBoxController.view.frame = CGRectMake(0, 44, 375, 75)
        self.view.addSubview(searchBoxController.view)
 */
